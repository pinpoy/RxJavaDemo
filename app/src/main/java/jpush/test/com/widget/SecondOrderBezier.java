...
public class SecondOrderBezier extends View {
    ...
    public SecondOrderBezier(Context context, AttributeSet attrs) {
        ...
        mPaintBezier.setStyle(Paint.Style.FILL_AND_STROKE); //描边加填充
...
//        canvas.drawCircle(mStartPointX, mStartPointY, 10, mPaintBezier);
//        canvas.drawRect(mAuxiliaryX, mAuxiliaryY, mAuxiliaryX + 100, mAuxiliaryY + 200, mPaintAuxiliary);
    }
