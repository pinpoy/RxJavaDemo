...
public class WebviewActivity_2 extends AppCompatActivity implements Bridge.RemoveWebListener {


    private static Bridge bridge;
    private BrowserInfo_2 browserInfo;
    private String jsPath = "/storage/emulated/0/TouchSprite/lua/i.js";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView webWebview1 = (WebView) findViewById(R.id.web_webview_1);
        ...
        browserInfo.setUrl("https://cpu.baidu.com/1043/fda9215b?scid=23749");
...
//            @Override
//            public void run() {
//                startActivity(new Intent(WebviewActivity_2.this, WebviewActivity_3.class));
//            }
//        }, 10 * 1000);
...
//                    view.loadUrl(browserInfo.getUrl());// 加载自定义错误页面
                    Toast.makeText(WebviewActivity_2.this, "onReceivedHttpError" + statusCode, Toast.LENGTH_SHORT).show();
                }
...
//                view.loadUrl(browserInfo.getUrl());// 加载自定义错误页面
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(WebviewActivity_2.this, "onReceivedError--webview加载url出现错误", Toast.LENGTH_SHORT).show();
